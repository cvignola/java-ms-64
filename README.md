...
### Project contents
The microservice application has a health endpoint which is accessible at `<host>:<port>/<contextRoot>/health`. The ports and context root are set in the pom.xml file.
